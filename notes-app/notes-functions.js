...
const generateNoteDOM = (note) => {
    ...
    if (note.tittle.length > 0) {
        textEl.textContent = note.tittle
    } else {
...
const renderNotes = (notes, filters) => {
    ...
    const filteredNotes = notes.filter((note) => note.tittle.toLowerCase().includes(filters.searchText.toLowerCase()))
